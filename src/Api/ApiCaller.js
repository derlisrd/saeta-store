...
import Axios from "axios";
import { APIURL, XAPITOKEN, SECRETO } from "../Config/globales";
...
export const APICALLER = {
  get: async ({
    ...
    try {
      ...
      //const res = axios({method:"GET",url:URLFINAL,headers:{'Access-Control-Allow-Origin': '*'}});
      //const res = axios({method:"GET",url:URLFINAL,headers:{'X-Api-Token': XAPITOKEN}});
